defmodule WhatFunWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WhatFunWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WhatFunWeb.Gettext, "errors", msg, opts)
    end
  end
